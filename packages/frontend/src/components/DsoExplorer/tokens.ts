// packages/frontend/src/components/DsoExplorer/tokens.ts
//
// Constants and helpers shared between DsoExplorer.tsx and QualityProfileTab.tsx.
// Kept apart from shared.tsx, which holds the shared components, because a
// .tsx module that exports anything besides components breaks React Fast
